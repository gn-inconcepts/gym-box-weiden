            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col lg:flex-row gap-6 h-[800px] lg:h-[600px]">
                    ...
                    >
                        ...
                        <div className="absolute top-8 right-8 z-20 font-display text-8xl text-white/5 group-hover:text-white/10 transition-colors">01</div>
                        ...
                        <div className="absolute bottom-0 left-0 p-10 md:p-14 z-20 w-full">
                            ...
                            <h2 className="font-display text-5xl md:text-6xl mb-4 text-white group-hover:text-brand-green transition-colors">{cms?.gymCardTitle ?? "Das Gym"}</h2>
                            <p className="text-zinc-300 text-lg mb-8 max-w-sm leading-relaxed opacity-0 lg:opacity-100 lg:group-hover:opacity-100 lg:h-0 lg:group-hover:h-auto lg:overflow-hidden transition-all duration-500">
                    ...
                    >
                        ...
                        <div className="absolute bottom-0 left-0 p-10 md:p-14 z-20 w-full">
                            ...
                            <h2 className="font-display text-5xl md:text-6xl mb-4 text-white group-hover:text-brand-green transition-colors">{cms?.boxCardTitle ?? "The Box"}</h2>
                            <p className="text-zinc-300 text-lg mb-8 max-w-sm leading-relaxed opacity-0 lg:opacity-100 lg:group-hover:opacity-100 lg:h-0 lg:group-hover:h-auto lg:overflow-hidden transition-all duration-500">
