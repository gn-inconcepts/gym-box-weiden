            ...
            <div className="space-y-4">
                {filteredServices.map((service) => {
                    ...
                    return (
                        <div
                            key={service.name}
                            className="bg-brand-dark border border-white/5 rounded-2xl p-6 md:p-8 hover:border-brand-green/30 transition-all duration-200 group animate-[fadeInScale_0.2s_ease-out_forwards]"
                        >
